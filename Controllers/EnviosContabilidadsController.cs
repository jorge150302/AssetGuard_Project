...
{
    public class EnviosContabilidadsController : Controller
    {
        private readonly AssetGuardDbContext _context;

        public EnviosContabilidadsController(AssetGuardDbContext context)
        {
            _context = context;
        }

        // GET: EnviosContabilidads
        ...
        // GET: EnviosContabilidads/Details/5
        ...
        // GET: EnviosContabilidads/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: EnviosContabilidads/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("IdEC,DescripcionEC,Auxiliar,CuentaDB,CuentaCR,MontoEnvioContabilida")] EnvioContabilidad envioContabilidad)
        {
        ...
        // GET: EnviosContabilidads/Edit/5
        ...
        // POST: EnviosContabilidads/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEC,DescripcionEC,Auxiliar,CuentaDB,CuentaCR,MontoEnvioContabilida")] EnvioContabilidad envioContabilidad)
        {
        ...
        // GET: EnviosContabilidads/Delete/5
        ...
        // POST: EnviosContabilidads/Delete/5
